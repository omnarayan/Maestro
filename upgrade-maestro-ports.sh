...
echo ""
echo "DeviceLab turns your team's Android & iOS devices into a private, secure"
echo "testing cloud. Running concurrent Maestro tests across multiple devices"
echo "required the ability to specify custom ports, which wasn't possible with"
echo "the default port 7001 configuration."
echo ""
